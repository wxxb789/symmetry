defmodule SymmetryControl.Repo.Migrations.AddHistoryLookupIndexes do
  ...
  def change do
    create_if_not_exists(
      index(:run_events, [:run_id, :inserted_at, :id],
        concurrently: true,
    ...
    create_if_not_exists(
      index(:run_transitions, [:run_id, :inserted_at, :id],
        concurrently: true,
    ...
    create_if_not_exists(
      index(:commands, [:task_id, :inserted_at, :id],
        concurrently: true,
    ...
    create_if_not_exists(
      index(:run_events, [:run_id, {:desc, :sequence}, {:desc, :id}],
        concurrently: true,
    ...
    create_if_not_exists(
      index(:run_transitions, [:run_id, {:desc, :inserted_at}, {:desc, :id}],
        concurrently: true,
